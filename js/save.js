define(["resources", "interact", "research"], function (resources, interact, research) {
    ...
    var exports = {
        ...
        export: function () {
            ...
            return LZString.compressToBase64(JSON.stringify(d));
        },
        ...
        import: function (data) {
            if (data != null) {
                var d;
                try {
                    d = JSON.parse(LZString.decompressFromBase64(data));
                } catch (e) {
        ...
        softclear: function () {
            var del = confirm("Are you sure you want to reset?  You will receive nothing!");
            if (del) {
                // TODO: prestige
                localStorage.clear();
                exports.shouldSaveOnClose = false;
